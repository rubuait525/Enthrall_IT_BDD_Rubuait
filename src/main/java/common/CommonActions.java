...
//import org.testng.Assert; // I did it

import com.google.common.io.Files;

import constants.Attribute;
// import reports.Loggers; [i did it]

public class CommonActions {
	static  Logger logger = LoggerFactory.getLogger(CommonActions.class); //1) here we used loggerslf4 instead of loggers(in tdd)
																												//1) because it create issues for junit and
																												//2) we make logger static because we will use it here only
																												//2) and another reason is our all method 
																												//2)are static if we have to use logger we have to make it static
	WebDriver driver;
